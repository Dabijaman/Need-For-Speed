    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            while (true)
            {
                ...
                {
                    Car newCar = new Car();//vseki pyt da syzdava nova kolichka
                    newCar.color = ConsoleColor.Cyan;
                    newCar.x = randomGenerator.Next(0, playFieledWidth);
                    newCar.y = 0;
                    newCar.c = 'V';
                    cars.Add(newCar);
                ...
                //print information
                PrintStringOnPossition(50, 21, "Lives: " + livesCount, ConsoleColor.Red);
                PrintStringOnPossition(50, 22, "Speed: " + speed, ConsoleColor.Blue);
                PrintStringOnPossition(50, 23, "Points: " + points, ConsoleColor.Yellow);
                PrintStringOnPossition(50, 24, "User is:" + userName, ConsoleColor.Yellow);
                PrintStringOnPossition(50, 25, "*Controls Games*" + info, ConsoleColor.Cyan);
                PrintStringOnPossition(50, 26, "#Buttons#" + info, ConsoleColor.Cyan);
                PrintStringOnPossition(50, 27, "[<]Left Right[>]" + info, ConsoleColor.Cyan);
                //slow down program
